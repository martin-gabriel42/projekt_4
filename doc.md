...
Tabulky byly vytvořeny pomocí CTE, vnořených SELECT dotazů a agregačních nebo window funkcí.
...
Růst cen chleba za měřené období převyšuje růst mezd v mnoha odvětvích, zvlášť pak v těch, které byly relativně lépe placené (např. Peněžnictví a pojišťovnictví, 
Těžba a dobývání). Obecně lze říct, že kupní síla se u chleba v měřených letech příliš nezměnila nebo ve vybraných odvětvích klesla.

Růst cen mléka je v pozorovaných letech nižší než růst mezd ve všech odvětvích s vyjímkou Peněžnictví a pojišťovnictví, kde kupní síla klesla. Obecně tedy u mléka
kupní síla rostla.
